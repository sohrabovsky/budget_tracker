...
# put your own DataFrame that you want to set in the worksheet
big_table= big_table.loc[:,:].astype(str).reset_index()
#worksheet.append_rows(big_table.values.tolist())
set_with_dataframe(worksheet, big_table)
